...
public class UserService {
  ...
  /**
   * Get all users currently stored in the database as data transfer objects. Code generated by AI.
   *
  ...
  /**
   * Convert user objects to a data transfer object. Code generated by AI.
   *
